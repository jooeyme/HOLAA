...
// Nama file log yang akan ditulis
const namaFileLog = 'log.txt';

// Tulis pesan ke dalam file log.txt
fs.writeFile(namaFileLog, PesanLog + '\n', (err) => {
  if (err) {
    console.error('Terdapat kesalahan saat menulis PesanLog ke file log.txt:', err);
  } else {
    console.log('PesanLog berhasil ditulis ke dalam file log.txt');
  }
});
